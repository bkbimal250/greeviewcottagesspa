...
export default function FoodCard({
  ...
  return (
    <article
      className="food-card group relative flex min-h-full flex-col overflow-hidden rounded-[1.5rem] border border-[#dfe5dc] bg-white shadow-[0_12px_34px_rgba(31,42,34,0.08)] transition duration-300 hover:-translate-y-1 hover:border-[#2f6b45]/35 hover:shadow-[0_22px_54px_rgba(31,42,34,0.16)]"
      style={{
    ...
    >
      ...
      <div className="flex flex-1 flex-col p-5 sm:p-6">
        ...
        {/* Pricing */}
        <div className="mt-5 grid grid-cols-2 gap-3 border-t border-[#edf1ea] pt-5">
          {hasHalfPrice ? (
        ...
        <div className="mt-auto pt-5">
          <Link
            ...
            className="inline-flex min-h-11 w-full items-center justify-between rounded-full bg-[#173d2a] px-5 text-sm font-bold text-white shadow-[0_10px_24px_rgba(23,61,42,0.2)] transition hover:bg-[#22543a] focus:outline-none focus-visible:ring-4 focus-visible:ring-[#2f6b45]/25"
          >
