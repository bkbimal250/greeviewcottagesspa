...
import BookingStaySummary from "@/components/booking/BookingStaySummary";
          ...
          <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_400px]">
            ...
            >
              ...
              <BookingGuestSelector
                ...
                maxAdultsForSelectedChildren={maxAdultsForSelectedChildren}
                maxChildrenForSelectedAdults={maxChildrenForSelectedAdults}
            ...
            <BookingStaySummary
              cottage={cottage}
              imageUrl={getImageUrl(cottage.thumbnail)}
              checkInLabel={formatDate(checkIn)}
              checkOutLabel={formatDate(checkOut)}
              displayedNights={displayedNights}
              guestSummary={guestSummary}
              weekdayNights={weekdayNights}
              saturdayNights={saturdayNights}
              sundayNights={sundayNights}
