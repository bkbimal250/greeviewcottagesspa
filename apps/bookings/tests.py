...
class BookingAppTests(TestCase):
    ...
    def booking_payload(self):
        return {
            ...
            "guest_email": "",
            "guest_address": "Sunrise House, Lake Road",
            "guest_city": "Mount Abu",
            "guest_state": "Rajasthan",
            "guest_country": "India",
            "guest_pincode": "307501",
    ...
    def test_booking_routes_are_registered(self):
        ...
        self.assertEqual(
            reverse("bookings:booking-lookup-request-otp"),
            "/api/v1/bookings/lookup/request-otp/",
        )
        self.assertEqual(
            reverse("bookings:booking-lookup-verify-otp"),
            "/api/v1/bookings/lookup/verify-otp/",
        )
        self.assertEqual(
            reverse("bookings:booking-lookup-details"),
            "/api/v1/bookings/lookup/details/",
        )
        self.assertEqual(
    ...
    def test_guest_booking_creation_calculates_backend_totals(self):
        ...
        self.assertEqual(booking.guest_address, "Sunrise House, Lake Road")
        self.assertEqual(booking.guest_city, "Mount Abu")
        self.assertEqual(booking.guest_state, "Rajasthan")
        self.assertEqual(booking.guest_country, "India")
        self.assertEqual(booking.guest_pincode, "307501")
    ...
    def test_guest_booking_rejects_disabled_online_payment(self):
        payload = self.booking_payload()
        payload["payment_method"] = Booking.PaymentMethod.ONLINE_GATEWAY
    ...
    def test_booking_lookup_requires_otp_before_token_details(self):
        booking = BookingService.create_guest_booking(self.booking_service_payload())
        ...
        otp = cache.get(f"booking-guest-otp:{booking.booking_id}:{booking.guest_phone}")
        ...
        token = verify_response.data["data"]["access_token"]
        ...
        self.assertEqual(details_response.data["data"]["booking_id"], booking.booking_id)
